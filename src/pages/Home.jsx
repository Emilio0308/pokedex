...
const Home = () => {
  ...
  return (
    <section className ='min-h-screen grid  grid-rows-[1fr_auto]'>
        <section className='grid content-center justify-center'>
            <article className='flex flex-col justify-center items-center gap-10 '>
                ...
                <form onSubmit={hanldeSubmit} className='w-[100%] flex'>
                    <input id='nameTrainer' type="text" className='outline-none flex-1 shadow-md' />
